...
extension comatprototypes {
    public class AdminUpdateSubjectStatus_Input: Codable {
        ...
        public init(deactivated: AdminDefs_StatusAttr?, subject: AdminUpdateSubjectStatus_Input_Subject, takedown: AdminDefs_StatusAttr?) {
    ...
    public enum AdminUpdateSubjectStatus_Input_Subject: Codable {
    ...
    public class AdminUpdateSubjectStatus_Output: Codable {
        public var subject: AdminUpdateSubjectStatus_Output_Subject
        public var takedown: AdminDefs_StatusAttr?

        public init(subject: AdminUpdateSubjectStatus_Output_Subject, takedown: AdminDefs_StatusAttr?) {
            self.subject = subject
            self.takedown = takedown
        }
    ...
    public enum AdminUpdateSubjectStatus_Output_Subject: Codable {
        case adminDefsRepoRef(AdminDefs_RepoRef)
        case repoStrongRef(RepoStrongRef)
        case adminDefsRepoBlobRef(AdminDefs_RepoBlobRef)
        case unknown(UnknownRecord)
    ...
    public enum AdminUpdateSubjectStatus_Error: XRPCError {
    ...
    public static func AdminUpdateSubjectStatus(client: any XRPCClientProtocol, input: AdminUpdateSubjectStatus_Input) async throws -> AdminUpdateSubjectStatus_Output {
        let params: Bool? = nil
        do {
            ...
            throw AdminUpdateSubjectStatus_Error(error: error)
        }
    }
}
