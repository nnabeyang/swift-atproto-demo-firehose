...
extension comatprototypes {
    public class SyncGetLatestCommit_Output: Codable {
    ...
    public enum SyncGetLatestCommit_Error: XRPCError {
    ...
    public static func SyncGetLatestCommit(client: any XRPCClientProtocol, did: String) async throws -> SyncGetLatestCommit_Output {
        ...
        do {
            ...
            throw SyncGetLatestCommit_Error(error: error)
        }
    }
}
