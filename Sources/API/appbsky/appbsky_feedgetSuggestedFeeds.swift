...
extension appbskytypes {
    public class FeedGetSuggestedFeeds_Output: Codable {
    ...
    public enum FeedGetSuggestedFeeds_Error: XRPCError {
    ...
    public static func FeedGetSuggestedFeeds(client: any XRPCClientProtocol, cursor: String?, limit: Int?) async throws -> FeedGetSuggestedFeeds_Output {
        ...
        do {
            ...
            throw FeedGetSuggestedFeeds_Error(error: error)
        }
    }
}
